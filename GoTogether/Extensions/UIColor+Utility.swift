...
extension UIColor {
    ...
    static var gtGreen: UIColor {
        return UIColor(red: 227/255, green: 255/255, blue: 230/255, alpha: 1)
    }
    static var gtBlue: UIColor {
        return UIColor(red: 220/255, green: 220/255, blue: 250/255, alpha: 1)
    }
    static var gtOrange: UIColor {
        return UIColor(red: 1, green: 231/255, blue: 218/255, alpha: 1)
    }
    static var gtRed: UIColor {
    ...
    static var gtSelected: UIColor {
        return UIColor(red: 235/255, green: 225/255, blue: 250/255, alpha: 1)
    }
}
